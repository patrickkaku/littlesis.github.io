...
<body>
	...
	<div  style="position:absolute;bottom:260px;right:5px;">
		<a href="http://<?php echo $row[4]; ?>" style=" text-decoration: none;"  target="_blank"><img src="./img/guanzhu.png" style="height:45px;width:45px;display: block;z-index: 21;">
	...
	<div  style="position:absolute;bottom:180px;right:5px;">
       <a href="http://<?php echo $row[5]; ?>" style=" text-decoration: none;"  target="_blank"> <img src="./img/tongcheng.png" style="height:45px;width:45px;display: block;z-index: 21;">
	...
	<div  style="position:absolute;bottom:100px;right:5px;">
      <a href="http://<?php echo $row[6]; ?>" style=" text-decoration: none;" target="_blank"> <img src="./img/dianzan.png" style="height:45px;width:45px;display: block;z-index: 21;">
	...
	<a href="./pay?fee=1" class="board-btn" style="background-color: rgb(252, 32, 103); color: rgb(255, 255, 255);text-decoration: none;">立即开通</a>
	</div>
	</div>
	</div>
	</div>
